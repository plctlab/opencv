...
list(APPEND CPU_ALL_OPTIMIZATIONS SIMD) # <experimental/simd>
...
if(1) # force to enable SIMD
  ocv_update(CPU_SIMD_TEST_FILE "${OpenCV_SOURCE_DIR}/cmake/checks/cpu_simd.cpp")
  ocv_update(CPU_KNOWN_OPTIMIZATIONS "SIMD")
  ocv_update(CPU_SIMD_FLAGS_ON "")
  ocv_update(CPU_SIMD_SUPPORTED ON)
  set(CPU_DISPATCH "SIMD" CACHE STRING "${HELP_CPU_DISPATCH}")
  set(CPU_BASELINE "SIMD" CACHE STRING "${HELP_CPU_BASELINE}")
  set(CPU_BASELINE_DETECT ON)
