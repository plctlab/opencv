...
list(APPEND CPU_ALL_OPTIMIZATIONS EXP_SIMD) # <experimental/simd>
...
if(1) # force to enable SIMD
  ocv_update(CPU_EXP_SIMD_TEST_FILE "${OpenCV_SOURCE_DIR}/cmake/checks/cpu_exp_simd.cpp")
  ocv_update(CPU_KNOWN_OPTIMIZATIONS "EXP_SIMD")
  ocv_update(CPU_EXP_SIMD_FLAGS_ON "")
  ocv_update(CPU_EXP_SIMD_SUPPORTED ON)
  set(CPU_DISPATCH "EXP_SIMD" CACHE STRING "${HELP_CPU_DISPATCH}")
  set(CPU_BASELINE "EXP_SIMD" CACHE STRING "${HELP_CPU_BASELINE}")
  set(CPU_BASELINE_DETECT ON)
